...
{
    public enum animalType { BigCat, Bird, Reptile}
    public enum foodType { Fruit, Vegetables, Seeds, Meat}
    public enum habitatType { Savannah, RainForest, Plains }
    //Struct for the dietry requirement for each animal. Each attribute has a getter and setter.
    public struct DietReq
    {
        public string typeFood { get; set; }
        public string numFeeds { get; set; }
        public List<string> feedTimes { get; set; }
    }
    //an interface for if the animal can climb or not
    public interface Iclimbable
    {
        string animalClimb();
    }
    //an interface for if the animal can swim or not
    public interface Iswimmable
    {
        string animalSwim();
    }
    //an interface for if the animal can fly or not
    ...
    public abstract class Animals : IMovable, Iclimbable, Iswimmable, IFlyable
    {
        ...
        protected habitatType bestHabitat;
        protected foodType bestFood;
        protected animalType typeAnimal;

        //constructor for the animal so that animal objects can be made
        public Animals(string aniName, int aniAge, string aniGender, habitatType bestHabitat, foodType bestFood, animalType typeAnimal)
        {
            this.aniName = aniName;
            this.aniAge = aniAge;
            this.aniGender = aniGender;
            this.bestHabitat = bestHabitat;
        ...
        public habitatType BestHabitat { get { return bestHabitat; } }
        public foodType BestFood { get { return bestFood; } }
        public animalType animalType { get { return typeAnimal; } }
        ...
        //methods for the interfaces for animal climb swim or fly
        public string animalClimb()
        {
            return "This animal can climb.";
        }

        public string animalSwim()
        {
        ...
        //a getter and setter for the struct
        public DietReq Diet { get; set; }
    ...
    public class Lion : Animals
    {
        ...
        public Lion(string aniName, int aniAge, string aniGender, habitatType bestHabitat,foodType bestFood,animalType type, bool hasMane) : base(aniName, aniAge, aniGender, bestHabitat,bestFood,type)
        {
...
Lionesses (female lions) are the primary hunters, using teamwork to bring down prey with coordinated strategies like ambushes and group chases.";
    ...
    public class Parrot : Animals
    {
        ...
        public Parrot(string aniName, int aniAge, string aniGender, habitatType bestHabitat, foodType bestFood, animalType type, string featherColor) : base(aniName, aniAge, aniGender, bestHabitat, bestFood, type)
        {
...
5. Parrots are highly social creatures. In the wild, they often live in large flocks, where they communicate through various vocalizations and body language. They form strong bonds with their mates and offspring, displaying complex social behaviors similar to those observed in primates.";
    ...
    public class Tortoise : Animals
    {
        ...
        public Tortoise(string aniName, int aniAge, string aniGender, habitatType bestHabitat, foodType bestFood, animalType type, string shellColor) : base(aniName, aniAge, aniGender, bestHabitat, bestFood, type)
        {
