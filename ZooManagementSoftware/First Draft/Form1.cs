namespace ZooManageEncycloFA2
{
    public partial class MainMenu : Form
    {
        ...
        public MainMenu()
        {
            ...
            Lion maleLion = new Lion("Peter", 7, "male", true);
            Lion femaleLion = new Lion("Lucy", 5, "female", false);
            oldlions.Add(maleLion);
            oldlions.Add(femaleLion);
            
            //Creates instances of the Parrot Class and adds to the lists
            Parrot maleParrot = new Parrot("Oliver", 12,"male","Green");
            Parrot femaleParrot = new Parrot("Mary", 15, "female", "Orange");
            parrots.Add(maleParrot);
            parrots.Add(femaleParrot);
            
            //Creates instances of the Tortoise Class and adds to the lists
            Tortoise maleTortoise = new Tortoise("Major HardShell", 35,"male","Black/Yellow");
            Tortoise femaleTortoise = new Tortoise("Myrtle", 30, "female", "Black/Yellow");
